    ...
    <div className="space-y-8">
      <div className="flex items-start gap-6">
        ...
        <div>
          ...
          <p className="text-emerald-400 font-medium">ÖPNV für Mannheim</p>
          <p className="text-sm text-neutral-400">RNV • Kostenlos • Open Source</p>
        </div>
      </div>

      <p className="text-lg text-neutral-300">
        Echtzeit-Daten des RNV auf deinem iPhone – <span className="text-emerald-400">ohne Account, ohne Werbung.</span>
      </p>
...
function FeatureGrid() {
  return (
    <div className="grid grid-cols-2 gap-4">
      {features.map((f) => (
        <div key={f.title} className="p-5 rounded-2xl bg-neutral-900/50 border border-neutral-800 hover:border-emerald-500/30 transition-all">
...
function StatsBar() {
  return (
    <div className="mt-16 p-6 rounded-2xl bg-neutral-900/30 border border-neutral-800 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
      <div><div className="text-2xl font-bold text-emerald-400">4.9 ★</div><div className="text-sm text-neutral-500">App Store</div></div>
